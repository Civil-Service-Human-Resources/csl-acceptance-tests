...
public class UserManagementService {
    ...
    final IdentityDBClient identityDBClient;

    final CsrsDBClient csrsDBClient;

    private Map<UserType, CSLUser> userMap;

    public UserManagementService(IdentityDBClient identityDBClient, CsrsDBClient csrsDBClient) {
        this.identityDBClient = identityDBClient;
        this.csrsDBClient = csrsDBClient;
    }
